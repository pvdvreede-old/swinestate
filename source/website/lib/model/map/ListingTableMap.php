...
class ListingTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('BEDROOMS', 'Bedrooms', 'INTEGER', false, null, 0);
		$this->addColumn('BATHROOMS', 'Bathrooms', 'INTEGER', false, null, 0);
		$this->addColumn('CAR_SPACES', 'CarSpaces', 'INTEGER', false, null, 0);
    ...
    $this->addRelation('ListingMetadataValue', 'ListingMetadataValue', RelationMap::ONE_TO_MANY, array('id' => 'listing_id', ), null, null);
