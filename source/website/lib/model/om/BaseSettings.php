...
abstract class BaseSettings extends BaseObject  implements Persistent {
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = SettingsPeer::TYPE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = SettingsPeer::NUM_COLUMNS - SettingsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSettings:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSettings:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSettings:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSettings:save:post') as $callable)
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingsPeer::TYPE)) $criteria->add(SettingsPeer::TYPE, $this->type);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseSettings:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseSettings::%s', $method));
	  }
