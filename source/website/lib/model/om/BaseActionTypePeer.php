...
/**
 * Base static class for performing query and update operations on the 'action_type' table.
 *
 * 
 *
...
abstract class BaseActionTypePeer {
	...
	const OM_CLASS = 'ActionType';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.ActionType';
	...
	const ID = 'action_type.ID';

	/** the column name for the NAME field */
	const NAME = 'action_type.NAME';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'action_type.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'action_type.UPDATED_AT';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ActionTypePeer::CREATED_AT);
		$criteria->addSelectColumn(ActionTypePeer::UPDATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseActionTypePeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      ActionType $value A ActionType object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ActionType $obj, $key = null)
	{
	...
	/**
	 * Method to invalidate the instance pool of all tables related to action_type
	...
	{
		return $withPrefix ? ActionTypePeer::CLASS_DEFAULT : ActionTypePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ActionType or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionTypePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseActionTypePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionTypePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseActionTypePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a ActionType or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionTypePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseActionTypePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ActionTypePeer::ID, $criteria->remove(ActionTypePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseActionTypePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseActionTypePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the action_type table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ActionTypePeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a ActionType or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(ActionType $obj, $cols = null)
	{
		$columns = array();
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseActionTypePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
