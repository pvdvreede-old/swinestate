...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	public function setEmailAddress($v)
	{
		...
		if ($this->email_address !== $v) {
			...
			$this->modifiedColumns[] = sfGuardUserProfilePeer::EMAIL_ADDRESS;
		}
	...
	public function setPhoneNumber($v)
	{
		...
		if ($this->phone_number !== $v) {
			$this->phone_number = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::PHONE_NUMBER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = sfGuardUserProfilePeer::NUM_COLUMNS - sfGuardUserProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::EMAIL_ADDRESS)) $criteria->add(sfGuardUserProfilePeer::EMAIL_ADDRESS, $this->email_address);
		if ($this->isColumnModified(sfGuardUserProfilePeer::PHONE_NUMBER)) $criteria->add(sfGuardUserProfilePeer::PHONE_NUMBER, $this->phone_number);
