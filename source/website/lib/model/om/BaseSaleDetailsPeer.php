...
abstract class BaseSaleDetailsPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AskingPrice', 'ActualPrice', 'AuctionDate', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'askingPrice', 'actualPrice', 'auctionDate', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ASKING_PRICE, self::ACTUAL_PRICE, self::AUCTION_DATE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'asking_price', 'actual_price', 'auction_date', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AskingPrice' => 1, 'ActualPrice' => 2, 'AuctionDate' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'askingPrice' => 1, 'actualPrice' => 2, 'auctionDate' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ASKING_PRICE => 1, self::ACTUAL_PRICE => 2, self::AUCTION_DATE => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'asking_price' => 1, 'actual_price' => 2, 'auction_date' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
