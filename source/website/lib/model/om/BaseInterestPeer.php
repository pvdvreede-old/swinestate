...
abstract class BaseInterestPeer {
	...
	const LISTING_ID = 'interest.LISTING_ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'interest.USER_ID';

	/** the column name for the INTEREST_STATUS field */
	const INTEREST_STATUS = 'interest.INTEREST_STATUS';

	/** the column name for the NEW_MARKER field */
	const NEW_MARKER = 'interest.NEW_MARKER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ListingId', 'UserId', 'InterestStatus', 'NewMarker', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'listingId', 'userId', 'interestStatus', 'newMarker', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LISTING_ID, self::USER_ID, self::INTEREST_STATUS, self::NEW_MARKER, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'listing_id', 'user_id', 'interest_status', 'new_marker', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ListingId' => 1, 'UserId' => 2, 'InterestStatus' => 3, 'NewMarker' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'listingId' => 1, 'userId' => 2, 'interestStatus' => 3, 'newMarker' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LISTING_ID => 1, self::USER_ID => 2, self::INTEREST_STATUS => 3, self::NEW_MARKER => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'listing_id' => 1, 'user_id' => 2, 'interest_status' => 3, 'new_marker' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		$criteria->addSelectColumn(InterestPeer::ID);
		$criteria->addSelectColumn(InterestPeer::LISTING_ID);
		$criteria->addSelectColumn(InterestPeer::USER_ID);
		$criteria->addSelectColumn(InterestPeer::INTEREST_STATUS);
		$criteria->addSelectColumn(InterestPeer::NEW_MARKER);
	...
	public static function doCountJoinListing(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(InterestPeer::LISTING_ID, ListingPeer::ID, $join_behavior);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(InterestPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Interest objects pre-filled with their Listing objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinListing(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to $obj2 (Listing)
	...
	/**
	 * Selects a collection of Interest objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Interest objects.
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to $obj2 (sfGuardUser)
				$obj2->addInterest($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Interest) to the collection in $obj2 (Listing)
				$obj2->addInterest($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Interest) to the collection in $obj3 (sfGuardUser)
	...
	/**
	 * Selects a collection of Interest objects pre-filled with all related objects except Listing.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptListing(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = InterestPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Interest) to the collection in $obj2 (sfGuardUser)
				$obj2->addInterest($obj1);
	...
	/**
	 * Selects a collection of Interest objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseInterestPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(InterestPeer::ID) && $criteria->keyContainsValue(InterestPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.InterestPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseInterestPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseInterestPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(InterestPeer::ID);
			$selectCriteria->add(InterestPeer::ID, $criteria->remove(InterestPeer::ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(InterestPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(InterestPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(InterestPeer::DATABASE_NAME);
			$criteria->add(InterestPeer::ID, $pks, Criteria::IN);
			$objs = InterestPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseInterestPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseInterestPeer::buildTableMap();
