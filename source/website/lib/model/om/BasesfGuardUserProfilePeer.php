...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'EmailAddress', 'PhoneNumber', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'lastName', 'emailAddress', 'phoneNumber', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::EMAIL_ADDRESS, self::PHONE_NUMBER, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'email_address', 'phone_number', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'EmailAddress' => 4, 'PhoneNumber' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'lastName' => 3, 'emailAddress' => 4, 'phoneNumber' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::EMAIL_ADDRESS => 4, self::PHONE_NUMBER => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'email_address' => 4, 'phone_number' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
