...
abstract class BaseSettingsPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Type', 'Name', 'Value', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'type', 'name', 'value', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TYPE, self::NAME, self::VALUE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type', 'name', 'value', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Type' => 1, 'Name' => 2, 'Value' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'type' => 1, 'name' => 2, 'value' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TYPE => 1, self::NAME => 2, self::VALUE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type' => 1, 'name' => 2, 'value' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SettingsPeer::TYPE);
		$criteria->addSelectColumn(SettingsPeer::NAME);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseSettingsPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Settings $value A Settings object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Settings $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SettingsPeer::getOMClass(false);
	...
	{
		return $withPrefix ? SettingsPeer::CLASS_DEFAULT : SettingsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Settings or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSettingsPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSettingsPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSettingsPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSettingsPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Settings or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSettingsPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSettingsPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSettingsPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSettingsPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the settings table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Settings or Criteria object OR a primary key value.
	 *
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSettingsPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
