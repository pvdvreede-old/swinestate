...
abstract class BaseListingTimeFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'total_paid'         => new sfWidgetFormFilterInput(),
      'payer_account_name' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'total_paid'         => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'payer_account_name' => new sfValidatorPass(array('required' => false)),
